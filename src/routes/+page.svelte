...
<section class="flex w-full flex-1 justify-center gap-4 py-4">
	{#await currentRoom}
		<div class="grid w-xl grid-cols-1 grid-rows-4 gap-4">
			<Card class="row-span-3 max-w-xl items-center justify-center">
				<Spinner type="default" color="primary" />
			</Card>
			<Card class="row-span-1 max-w-xl items-center justify-center">
				<Spinner type="default" color="primary" />
			</Card>
		</div>
	{:then curr}
		...
		<div class="grid w-xl grid-cols-1 grid-rows-4 gap-4">
			<Card class="relative row-span-3 min-w-full items-center justify-center gap-5 p-5">
